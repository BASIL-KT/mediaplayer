...
function Videocard({video,res,cond}) {
  ...
  return (
    <>
       <Card style={{ width: '17rem' }} draggable onDragStart={(e)=>{handleDrag(e)}}>
      <Card.Img variant="top" onClick={handleShow} style={{cursor:'pointer'}} src={video?.imageUrl} />
      <Card.Body>
        <Card.Title>{video.title}</Card.Title>
        {
          !cond &&
          <Button variant='' onClick={handleDelete}><i className="fa-solid fa-trash fa-2xl" style={{color: "#cf0707",}} /></Button>
